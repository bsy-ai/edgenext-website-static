...
const TopCloudProvider: React.FC = () => {
  return (
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                <div className="text-[#0EB623] text-sm font-medium mb-4">News • June 26, 2023</div>
                <h1 className="text-[32px] md:text-[48px] font-medium mb-6 leading-[1.2] w-full">
                  EdgeNext has been included in the Top Cloud Computing Service Provider Companies by Software Testing Help
                </h1>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="prose max-w-none">
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    🎉 Exciting news! EdgeNext has been included in the top cloud computing service providers by Software Testing Help! 💻🏆
                  </p>
                  
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    Delivering exceptional cloud-based solutions to APAC, China, and MEA, we optimize digital operations, enhance content delivery, and guarantee reliable performance. 🚀
                  </p>

                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    Embrace the power of edge computing with EdgeNext!⚡
                  </p>

                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    Learn more: <a href="https://www.softwaretestinghelp.com/cloud-computing-service-providers/" className="text-[#0EB623] hover:underline" target="_blank" rel="noopener noreferrer">https://www.softwaretestinghelp.com/cloud-computing-service-providers/</a>
                  </p>
                  ...
                  <p className="text-gray-600 mb-8">
                    Software Testing Help is a leading online resource for software testing and quality assurance professionals. The platform provides comprehensive guides, tutorials, and reviews on various software testing tools, methodologies, and services. Their recognition of EdgeNext as a top cloud computing service provider highlights our commitment to delivering high-quality, reliable cloud solutions to businesses worldwide.
                  </p>
                </div>
              </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">Recognized as a top cloud computing service provider</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Specialized in APAC, China, and MEA regions</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Optimized digital operations and content delivery</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Reliable performance and edge computing capabilities</span>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-2xl overflow-hidden hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                <a href="/adtiming-is-now-powered-by-edgenext-edge-cloud-platform" className="block">
                  <div className="aspect-video bg-gradient-to-br from-[#0EB623]/10 to-[#0EB623]/5 relative overflow-hidden">
                    <img 
                      src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg"
...
export default TopCloudProvider;