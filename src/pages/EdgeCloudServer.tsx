...
const EdgeCloudServer: React.FC = () => {
  ...
  const [trialFormData, setTrialFormData] = useState({ email: '', company: '' });
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8 max-w-4xl mx-auto font-light">
                EdgeNext Edge Cloud Server (ECS) leverages 1,500+ global edge nodes to create an
                edge computing network, bringing cloud power closer to end users. It delivers
                low-latency, scalable services worldwide, with a focus on emerging markets with high
                computing demand across Asia, the Middle East, Africa, North America, and Oceania.
              </p>
        ...
        {/* Start Your Free Trial Section (commented out) */}
        {/*
          ...
          <div className="container mx-auto px-4 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-medium mb-4 group-hover:text-[#0EB623] transition-colors duration-300">
                  Sub-Second Latency
                </h3>
                <p className="text-gray-600">
                  Reduce latency by up to 80% with our edge locations positioned closer to your
                  users worldwide.
                </p>
              </div>
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Edge nodes not only in developed regions, but in emerging markets like Libya,
                  Pakistan, Uzbekistan — deploy where others can't.
                </p>
              </div>
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                <div className="w-14 h-14 bg-[#0EB623]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-gray-600">
                  Meet regional data laws and bank-level security needs with localized
                  infrastructure and multilayer protection.
                </p>
              </div>
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                <div className="w-14 h-14 bg-[#0EB623]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-gray-600">
                  Tailor CPU, memory, storage, and regions to your needs. Deploy across multiple
                  regions and AZs for low latency and resilience.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-white/90 mb-8">
                Get started with ECS today and experience the power of edge computing within 5
                minutes
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <span className="text-white/90">Offer ends soon</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Deploy your applications in seconds with our one-click deployment system and
                    automated scaling.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Automatically scale resources up or down based on demand with intelligent load
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Monitor performance, traffic, and resource usage with comprehensive analytics and
                    alerts.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Distributed storage with automatic replication and backup across edge locations,
                    up to 20 cloud disks per instance.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Deploy in your own Virtual Private Network (VPC) with isolated subnets and
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Protect your workloads with built-in firewalls and intrusion detection, creating
                    a bank-level defense layer.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group bg-white rounded-2xl p-6 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-4">
                  Reduce game latency by{' '}
                  <span className="text-[#0EB623] font-medium">57%</span> and provide seamless
                  multiplayer experiences with edge servers close to players.
                </p>
              ...
              <div className="group bg-white rounded-2xl p-6 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-4">
                  Process IoT data at the edge for real-time decision making and reduced bandwidth
                  costs.
                </p>
              ...
              <div className="group bg-white rounded-2xl p-6 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-4">
                  Deliver video, images, and static content with lightning-fast speeds and{' '}
                  <span className="text-[#0EB623] font-medium">99.9%</span> availability.
                </p>
              ...
              <div className="group bg-white rounded-2xl p-6 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-4">
                  Handle seasonal surges, high-volume transactions, and flash sales with elastic
                  compute and load balancing.
                </p>
                <p className="text-[#0EB623] font-medium">
                  2× faster response during peak traffic
                </p>
              </div>
              <div className="group bg-white rounded-2xl p-6 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                <img
                ...
                <p className="text-gray-600 mb-4">
                  Power fintech, healthcare, and other critical apps with encrypted,
              ...
              <div className="group bg-white rounded-2xl p-6 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-4">
                  Run pre-trained AI models at the edge for voice, image, and chatbot services. Cut
                  latency bottlenecks.
                </p>
          ...
          <div className="container mx-auto px-4 relative">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the right plan for your project, with flexible performance options and
                competitive pricing.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">
                  Deployed custom edge nodes to support its rapid growth across MEA, SEA, and Europe
                  with <span className="text-[#0EB623] font-medium">30%+</span> cost savings,
                  smoother gameplay.
                </p>
              </div>
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">
                  Ensured regional compliance and improved connectivity across Central Asia with
                  local edge nodes and optimized networking.
                </p>
              </div>
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                <div className="w-12 h-12 bg-[#0EB623]/10 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-gray-600 mb-6">
                  Reduced buffering by <span className="text-[#0EB623] font-medium">80%</span> and
                  cut transmission distance by over{' '}
                  <span className="text-[#0EB623] font-medium">90%</span>, with caches pushed closer
                  to users and a custom network solution.
                </p>
              </div>
            </div>
          </div>
...
<section className="py-24 bg-gradient-to-r from-[#0EB623] to-[#0CA61F] relative overflow-hidden">
  {/* 背景层加 pointer-events-none，防止挡点击 */}
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.12)_0%,transparent_50%)] pointer-events-none"></div>
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(255,255,255,0.12)_0%,transparent_50%)] pointer-events-none"></div>
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <p className="text-lg md:text-xl text-white/90 mb-10">
        Tell us about your workloads, regions, and growth plans. Our team will help you
        design an ECS deployment that fits your performance, compliance, and budget needs.
      </p>
