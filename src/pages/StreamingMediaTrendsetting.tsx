...
const StreamingMediaTrendsetting: React.FC = () => {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                ...
                <h1 className="text-[32px] md:text-[48px] font-medium mb-6 leading-[1.2] w-full">
                  EdgeNext Unified Global Edge Cloud Platform has been recognized as one of Streaming Media's Trendsetting Products and Services
                </h1>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="prose max-w-none">
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    The streaming market has experienced significant growth in recent years. 🔥We are delighted to announce that EdgeNext Unified Global Edge Cloud Platform has been recognized as one of Streaming Media's Trendsetting Products and Services.
                  </p>
                  
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    <a href="https://www.streamingmedia.com/Articles/Editorial/Featured-Articles/Streaming-Medias-Trendsetting-Products-and-Services-of-2023-159036.aspx" className="text-[#0EB623] hover:underline" target="_blank" rel="noopener noreferrer">
                      https://www.streamingmedia.com/Articles/Editorial/Featured-Articles/Streaming-Medias-Trendsetting-Products-and-Services-of-2023-159036.aspx
                    </a>
                  </p>

                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    Contact us to revolutionize your streaming business with unparalleled scalability, superior streaming quality, and unmatched performance.😉
                  </p>
                  ...
                  <h2 className="text-2xl font-medium mb-4">About Streaming Media</h2>
                  <p className="text-gray-600 mb-8">
                    Streaming Media is a leading industry publication that provides professionals in the online video industry with the information and resources they need to make critical business decisions. The publication covers the entire online video ecosystem, from content creation to monetization and delivery, and is known for its in-depth analysis, industry insights, and recognition of innovative products and services that are shaping the future of streaming.
                  </p>
                </div>
              </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">Recognized by Streaming Media</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Trendsetting product in streaming industry</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Unified Global Edge Cloud Platform</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Superior streaming quality and performance</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-medium">Video on Demand</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-[#0EB623]/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-2xl overflow-hidden hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                <a href="/resources/news/edgenext-top-ddos-protection-services" className="block">
                  <div className="aspect-video bg-gradient-to-br from-[#0EB623]/10 to-[#0EB623]/5 relative overflow-hidden">
                    <img 
                      src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg"
                      alt="EdgeNext DDoS Protection"
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                    />
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-medium mb-3 text-gray-900 group-hover:text-[#0EB623] transition-colors duration-300">
                      EdgeNext is listed as one of the Top DDoS Protection Services
                    </h3>
        ...
        <section className="py-16 bg-[#0EB623]">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h2 className="text-2xl md:text-3xl font-medium text-white mb-2">Ready to enhance your streaming capabilities?</h2>
...
export default StreamingMediaTrendsetting;