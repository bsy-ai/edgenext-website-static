    ...
    <div className="max-w-4xl mx-auto text-center">
      <h2 className="text-3xl md:text-4xl font-medium text-white mb-6">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-10">
                EdgeNext empowers e-commerce platforms with ultra-low latency, reliable uptime,
                and localized delivery—so you can scale across emerging markets with confidence.
              </p>
