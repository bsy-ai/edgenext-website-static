          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                <div className="text-[#0EB623] text-sm font-medium mb-4">News • April 4, 2023</div>
              ...
              <div className="lg:col-span-5">
                <div className="rounded-xl overflow-hidden shadow-md">
                  <img 
                    src="/edgenext-apac-team-1.jpg"
                    alt="EdgeNext APAC Team New Office"
              ...
              <div className="lg:col-span-2">
                <div className="prose max-w-none">
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    📣It's official – the EdgeNext APAC team has a new home! We're excited to be settled into our new office and can't wait to see what the future holds. 💪As we celebrate our 2nd anniversary in Singapore, we're grateful for all the hard work and milestones that have led us to this point. Thank you to our community for your support! 🙌
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="rounded-xl overflow-hidden shadow-md">
                      <img 
                        src="/edgenext-apac-team-2.jpg"
                        alt="EdgeNext APAC Team New Office"
                  ...
                  <p className="text-gray-600 mb-8">
                    As part of its ongoing commitment to expanding its presence and capabilities, EdgeNext has been actively growing its infrastructure throughout the Asia Pacific (APAC) region. This expansion allows EdgeNext to provide tailored, high-performance solutions for major Internet Service Providers (ISPs), local businesses, international organizations, and strategic partners, ensuring their specific needs are met with precision and efficiency.
                  </p>

                  <h2 className="text-2xl font-medium mb-4">EdgeNext in APAC</h2>
                  <p className="text-gray-600 mb-8">
                    The new office in Singapore marks a significant milestone for EdgeNext's growth in the APAC region. As a strategic hub for technology and business in Southeast Asia, Singapore provides EdgeNext with an ideal location to strengthen its regional presence and better serve its growing client base in the area.
                  </p>

                  <p className="text-gray-600 mb-8">
                    With this expansion, EdgeNext continues to demonstrate its commitment to providing localized support and services to clients across the APAC region, ensuring they receive the highest level of service and expertise tailored to their specific market needs.
                  </p>
                </div>
              </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">New office in Singapore</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Celebrating 2nd anniversary in Singapore</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Expanding presence in APAC region</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Strengthening regional support capabilities</span>
                      </div>
                    </div>
                  </div>
