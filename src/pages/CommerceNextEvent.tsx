...
import { ArrowRight, Check, Globe, Shield, Zap, Server, Database, RefreshCw, Cloud, Building2, Map, MapPin, ShoppingCart } from 'lucide-react';
import { Link } from 'react-router-dom';

const CommerceNextEvent: React.FC = () => {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                ...
                <h1 className="text-[32px] md:text-[48px] font-medium mb-6 leading-[1.2] w-full">
                  EdgeNext in CommerceNext Ecommerce Growth Show 2023
                </h1>
              </div>
              <div className="lg:col-span-5">
                <div className="rounded-xl overflow-hidden shadow-md">
                  <img 
                    src="/commercenext-ecommerce-growth-show-1.jpeg"
                    alt="EdgeNext at CommerceNext Ecommerce Growth Show"
              ...
              <div className="lg:col-span-2">
                <div className="prose max-w-none">
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    🎉 EdgeNext's participation in the CommerceNext Ecommerce Growth Show was a resounding success! Engaging with numerous industry leaders, we had fruitful 💡discussions and a remarkable experience throughout the event. We look forward to leveraging these connections to drive growth and innovation in the e-commerce landscape.
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="rounded-xl overflow-hidden shadow-md">
                      <img 
                        src="/commercenext-ecommerce-growth-show-2.jpeg"
                        alt="EdgeNext at CommerceNext Ecommerce Growth Show"
                    ...
                    <div className="rounded-xl overflow-hidden shadow-md">
                      <img 
                        src="/commercenext-ecommerce-growth-show-3.jpeg"
                        alt="EdgeNext at CommerceNext Ecommerce Growth Show"
                        className="w-full h-auto"
                      />
                    </div>
                  ...
                  <h2 className="text-2xl font-medium mb-4">About CommerceNext</h2>
                  <p className="text-gray-600 mb-8">
                    CommerceNext is a premier event for retail and e-commerce professionals, bringing together industry leaders, innovators, and decision-makers to share insights, strategies, and best practices. The Ecommerce Growth Show provides a platform for networking, learning, and exploring the latest trends and technologies shaping the future of commerce.
                  </p>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">Successful participation in CommerceNext</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Engaged with industry leaders</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Fruitful discussions on e-commerce growth</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Building connections for future innovation</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-[#0EB623]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                          <ShoppingCart className="text-[#0EB623]" size={18} />
                        </div>
                        <div>
...
export default CommerceNextEvent;