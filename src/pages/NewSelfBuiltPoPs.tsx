...
const NewSelfBuiltPoPs: React.FC = () => {
  return (
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                <div className="text-[#0EB623] text-sm font-medium mb-4">News • June 28, 2023</div>
                <h1 className="text-[32px] md:text-[48px] font-medium mb-6 leading-[1.2] w-full">
                  EdgeNext New Self-built PoPs in the Middle East, Southeast Asia, and Latin America are online now
                </h1>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="prose max-w-none">
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    We're excited to announce the recent launch of multiple EdgeNext self-built PoPs. With this expansion, we're better positioned than ever to 🚀bolster your business growth on a global scale. 🌍🌍🌍
                  </p>
                  
                  <h2 className="text-2xl font-medium mb-4">The new PoPs include:</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gray-50 rounded-xl p-6 shadow-sm">
                      <h3 className="text-xl font-medium mb-4">Middle East</h3>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 shadow-sm">
                      <h3 className="text-xl font-medium mb-4">Southeast Asia</h3>
                      <ul className="space-y-2 text-gray-600">
                        <li>Jessore</li>
                        <li>Da Nang</li>
                        <li>Phnom Penh</li>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 shadow-sm">
                      <h3 className="text-xl font-medium mb-4">Latin America</h3>
                      <ul className="space-y-2 text-gray-600">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    EdgeNext is committed to fuelling your success and look forward to propelling your global journey.😉
                  </p>
                  ...
                  <p className="text-gray-600 mb-8">
                    As part of its ongoing commitment to expanding its presence and capabilities, EdgeNext has been actively growing its infrastructure throughout the Middle East, Southeast Asia, and Latin America regions. This expansion allows EdgeNext to provide tailored, high-performance solutions for major Internet Service Providers (ISPs), local businesses, international organizations, and strategic partners, ensuring their specific needs are met with precision and efficiency.
                  </p>
                </div>
              </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">New PoPs in Middle East, Southeast Asia, and Latin America</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Expanded coverage in 12 cities</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Enhanced global network infrastructure</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Improved performance for global businesses</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-white/90">
                  Try EdgeNext's global network and accelerate your business worldwide.
                </p>
              </div>
              <a 
                href="/company/contact" 
...
export default NewSelfBuiltPoPs;