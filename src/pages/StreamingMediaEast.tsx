...
const StreamingMediaEast: React.FC = () => {
  return (
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                <div className="text-[#0EB623] text-sm font-medium mb-4">News • May 23, 2023</div>
              ...
              <div className="lg:col-span-5">
                <div className="rounded-xl overflow-hidden shadow-md">
                  <img 
                    src="/streaming-media-east-1.jpeg"
              ...
              <div className="lg:col-span-2">
                <div className="prose max-w-none">
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    🎥 What an unforgettable experience it was to attend Streaming Media East 2023! We got the opportunity to discuss the latest streaming trends, network with industry leaders, and share our own insights on the future of the industry. Thank to everyone who connected with us on-site. We get so much inspiration from all of you.
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="rounded-xl overflow-hidden shadow-md">
                      <img 
                        src="/streaming-media-east-2.jpeg"
                        alt="EdgeNext at Streaming Media East"
                    ...
                    <div className="rounded-xl overflow-hidden shadow-md">
                      <img 
                        src="/streaming-media-east-3.jpeg"
                        alt="EdgeNext at Streaming Media East"
                        className="w-full h-auto"
                      />
                    </div>
                  ...
                  <h2 className="text-2xl font-medium mb-4">About Streaming Media East</h2>
                  <p className="text-gray-600 mb-8">
                    Streaming Media East is one of the premier industry events focused on the business and technology of online video. The conference brings together streaming professionals, content creators, technology providers, and industry experts to discuss the latest trends, innovations, and challenges in the streaming media landscape.
                  </p>

                  <p className="text-gray-600 mb-8">
                    The event features keynote presentations, panel discussions, networking opportunities, and exhibitions showcasing cutting-edge streaming technologies and solutions. It serves as a vital platform for industry professionals to exchange ideas, forge partnerships, and stay ahead of the rapidly evolving streaming ecosystem.
                  </p>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">Latest streaming trends and technologies</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-600">Sharing insights on the future of streaming</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-[#0EB623]/10 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                          <Check className="text-[#0EB623]" size={16} />
                        </div>
                        <span className="text-gray-600">Valuable connections and partnerships</span>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-2xl overflow-hidden hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                <a href="/resources/news/edgenext-jetstream-epeak-eo-events-china" className="block">
                  <div className="aspect-video bg-gradient-to-br from-[#0EB623]/10 to-[#0EB623]/5 relative overflow-hidden">
                    <img 
                      src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg"
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-medium mb-3 text-gray-900 group-hover:text-[#0EB623] transition-colors duration-300">
                      EdgeNext, Jet-Stream, and EPEAK Studio Partnership for Live-streaming
                    </h3>
...
export default StreamingMediaEast;