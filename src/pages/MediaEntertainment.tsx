      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-[40px] md:text-[60px] font-bold mb-6 leading-[1.1]">
                  ...
                  <span className="animated-gradient-text block mt-2">We Move Faster</span>
                </h1>
                <p className="text-lg md:text-xl text-gray-600 mb-8">
                  EdgeNext delivers ultra-fast, secure, and reliable media experiences—from live news to global streaming—powered by localized edge delivery and advanced threat protection.
                </p>
                <Link 
                  to="/contact_us" 
        ...
        <section className="py-24 bg-[#F9F9F9]">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-4xl font-medium mb-6">What's Holding Media Back?</h2>
                <p className="text-lg text-gray-600">
                  At the heart of today's media challenges are unpredictable traffic surges, evolving security threats, and the demand for instant content refresh.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                  ...
                  <h3 className="text-xl font-medium mb-4">Unpredictable Traffic Surges</h3>
                  <p className="text-gray-600">Major events can crash your site without warning.</p>
                </div>
                <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                  <div className="w-14 h-14 bg-[#0EB623]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    <Shield className="text-[#0EB623]" size={28} />
                  </div>
                  <h3 className="text-xl font-medium mb-4">Security Risks & Attacks</h3>
                  <p className="text-gray-600">DNS hijacking, DDoS, and content tampering damage your brand.</p>
                </div>
                <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                  <div className="w-14 h-14 bg-[#0EB623]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <p className="text-gray-600">Slow refresh means lost authority and users.</p>
                </div>
                <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                  <div className="w-14 h-14 bg-[#0EB623]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    <Play className="text-[#0EB623]" size={28} />
                  </div>
                  <h3 className="text-xl font-medium mb-4">Playback Interruptions</h3>
                  <p className="text-gray-600">Live events and VOD need to stream flawlessly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-gray-900 relative overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(45deg,rgba(14,182,35,0.1)_25%,transparent_25%,transparent_75%,rgba(14,182,35,0.1)_75%,rgba(14,182,35,0.1))] bg-[length:60px_60px] animate-[flow_20s_linear_infinite]"></div>
          </div>
          
          <div className="container mx-auto px-4 relative">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-medium mb-6 text-white">
                Future-Proof Streaming <span className="text-[#0EB623]">for a Real-Time World</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                From latency-sensitive live streaming to secure content refresh, EdgeNext's edge platform empowers media providers to move faster, safer, and smarter.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:bg-white/20 transition-all duration-500">
                ...
                <div className="text-xl font-semibold mb-2 text-white">Response Time</div>
        ...
        <section className="py-24 bg-[#F9F9F9]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-medium mb-4">Media Infrastructure <span className="text-[#0EB623]">Built for the Future</span></h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Powerful, edge-first media solutions that scale with your audience—wherever they are.
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
              <div className="order-2 lg:order-1">
                <h3 className="text-2xl font-medium mb-4">Hot Backup for Instant Recovery</h3>
                <p className="text-gray-600 mb-6">
                  Restore content fast during origin failures to keep media delivery uninterrupted.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">Real-time edge-based backup</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">Prevents hijacks and outages</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
              ...
              <div>
                <h3 className="text-2xl font-medium mb-4">AI-Driven Threat Defense</h3>
                <p className="text-gray-600 mb-6">
                  Stop attacks before they spread with smart detection and expert response.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">SIEM analytics at the edge</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">Real-time root cause analysis</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">Safeguards brand and content</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="order-2 lg:order-1">
                <h3 className="text-2xl font-medium mb-4">Millisecond Content Updates</h3>
                <p className="text-gray-600 mb-6">
                  Deliver real-time news and updates with millisecond-level efficiency using P2P and smart routing.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">P2P technology for faster propagation</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">Network-wide refresh in milliseconds</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Check className="text-[#0EB623]" size={20} />
                    <span className="text-gray-600">Keeps content timely and relevant</span>
                  </li>
                </ul>
              </div>
              <div className="order-1 lg:order-2">
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-medium mb-4">Tailoring Media Delivery for Dynamic Moments</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Power real-time news updates, major event livestreams, and on-demand video experiences with low-latency, scalable infrastructure—wherever your audience is.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                ...
                />
                <h3 className="text-2xl font-medium mb-4">CCTV – CDN Streaming Solution</h3>
                <p className="text-gray-600 mb-6">
                  China Central Television (CCTV) operates one of the largest-scale digital video databases in the country, supporting over 11.06 million simultaneous online viewers during major broadcasts with EdgeNext's comprehensive streaming solution.
                </p>
                <Link to="/cctv-cdn-streaming-solution" className="text-[#0EB623] font-medium inline-flex items-center group-hover:gap-2 transition-all duration-300">
                  Read Case Study
              ...
              <div className="group bg-white rounded-2xl p-8 hover:shadow-[0_20px_60px_-15px_rgba(14,182,35,0.15)] transition-all duration-500 hover:-translate-y-2">
                <img 
                  ...
                  className="w-full h-48 object-cover rounded-xl mb-6"
                />
                <h3 className="text-2xl font-medium mb-4">Beijing 2022 Winter Olympic Games – CDN Streaming Solution</h3>
                <p className="text-gray-600 mb-6">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <form className="media-entertainment-contact-form space-y-4" onSubmit={handleSubmit}>
                  <div>
