          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <form className="telecommunication-contact-form space-y-4" onSubmit={handleSubmit}>
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:border-white transition-all duration-300"
                      required
                    />
                  </div>
                  <div>
                  ...
                  >
                    {isSubmitted ? '✓ Message Sent!' : (
                      <>
                        Get in Touch
                        <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform duration-200 inline-block" size={20} />
                      </>
                    )}
                  </button>
                </form>
