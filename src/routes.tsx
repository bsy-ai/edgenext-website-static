...
export const routes: RouteRecord[] = [
{
  ...
  { path: 'global_cdn', Component: GlobalCDN },
  { path: 'china_cdn', Component: ChinaCDN },
  { path: 'southeast_asia_cdn', Component: SoutheastAsiaCDN },
  ...
  { path: 'live_streaming', Component: LiveStreaming },
  { path: 'security_cdn', Component: SecurityCDN },
  { path: 'anti_ddos', Component: AntiDDoS },
  { path: 'dns_security_service', Component: DNSSecurity },
  { path: 'bare_metal_server', Component: BareMetalServer },
  { path: 'IP_Transit', Component: IPTransit },
  { path: 'mea_cdn', Component: MENACDN },
  { path: 'gaming', Component: Gaming },
  { path: 'solutions/media-entertainment', Component: MediaEntertainment },
  { path: 'media_and_entertainment', Component: MediaEntertainment },
  { path: 'e_commerce', Component: Ecommerce },
  { path: 'sports_broadcasting', Component: SportsBroadcasting },
  { path: 'telcos-isp-iigs', Component: Telecommunication },
  { path: 'e_learning', Component: ELearning },
  ...
  // ── Case Studies ──
  { path: 'case_study', Component: CaseStudies },
  {
  ...
  { path: 'thank_you', Component: ThankYou },
